Dropzone.autoDiscover=false;
     ...
     $(function(){
        ...
        let cs_title = document.getElementsByName("cs_title").value;
        let cs_content = document.getElementsByName("cs_content").value;
        let cs_eventbannerImg = document.getElementsByName("cs_eventbannerImg").value;
